    ...
    <div class="contBlan4">
     ...
     <div class="scrollY">   
        <div class="carrousel3">  
            ...
            $sql=$conexion->query("select * from receta where tipo_comida='almuerzo'");
            while ($datos = $sql->fetchObject()){ ?>
                <div class="elemento">
                    <div class="plato2">
                    <img id="imgNombreComidas" src="<?= $datos->foto?>" alt="">
                        <div id="check">
                            <a href="receta_categoria_almuerzo_nutri.php?ID=<?= $datos->ID ?>"><i class="fa-solid fa-trash-can"></i></a>
